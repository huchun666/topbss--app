...
@Component({
  selector: 'page-brandshop-order-receipted',
  templateUrl: 'brandshop-order-receipted.html',
})
export class BrandshopOrderReceiptedPage {
  ...
  getOrderList() {
    ...
    var url = `${AppConfig.API.getOrderList}?status=3&start=${this.start}&limit=${this.pageSize}`;
    if (this.paramsDate != '')
      url += this.paramsDate;
